 ...
 member_favorite varchar(50)
  ...
  drop table MEMBER;		  drop table MEMBER;
  		  
 insert into MEMBER(member_id,member_passwd,member_name,member_reg_date,member_gender) 		 +insert into MEMBER values('admin','$2a$10$QxYtHTU2SRnLC.g1g8.E6ucImfLpigsmCxNF3BiSyUU7gDnrkpf52','°ü¸®ÀÚ',getdate(),'M','');
